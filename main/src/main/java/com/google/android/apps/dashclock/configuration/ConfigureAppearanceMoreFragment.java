...
/**
 * Fragment for allowing the user to configure advanced appearance settings.
 */
public class ConfigureAppearanceMoreFragment extends PreferenceFragment
        implements SharedPreferences.OnSharedPreferenceChangeListener {

    private View mListBackgroundView;
    private ListView mListView;

    public ConfigureAppearanceMoreFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_configure_appearance_more, container, false);
        mListBackgroundView = rootView.findViewById(R.id.listview_background);
    ...
    private void updateListBackgroundPosition() {
        ...
        top = Math.max(0, top);
        mListBackgroundView.setTranslationY(top);
        ((ConfigureAppearanceFragment) getParentFragment()).setAppearanceContainerTranslationY(top - topPadding);
    }
